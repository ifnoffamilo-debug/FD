...
PERSONAL_INCOME_CATEGORIES = (
    "Зарплата", "Перевод", "Возврат", "Возврат долга", "Продажа", "Прочий доход",
)
PERSONAL_EXPENSE_CATEGORIES = (
    "Продукты", "Дом", "Автомобиль", "Покупки", "Развлечения", "Одежда",
    "Подписки и связь", "Путешествия", "Налоги", "Погашение долга", "Прочий расход",
)
...
FUEL_TYPES = ("Бензин", "Газ")
DEBT_DIRECTIONS = {"to_me": "Мне должны", "i_owe": "Я должен"}
